...
public class ImagePickerFragment extends Fragment {
    ...
    private void requestStoragePermission(final boolean isCamera) {
        ...
        if (!Constants.CheckPermission(getActivity(), android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            reportUpdateError(Constants.EC_IMAGE_PICKER_PERMISSION_FAILED, "WRITE_EXTERNAL_STORAGE permission required");
            return;
        }
        if (isCamera) {
