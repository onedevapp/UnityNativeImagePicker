    ...
    public void openImagePicker() {
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                /*Fragment request = ImagePickerFragment.newInstance(selectedListener, mCompressor, bundle);
                request.setArguments(bundle);
                ((Activity)getActivity()).getFragmentManager().beginTransaction().add(0, request).commit();*/
            }
        });
    }
    //endregion
